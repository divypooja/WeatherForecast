...
- **Scrap Tracking per Process**: Added "Expected Scrap" field to each process in multi-process job work workflows, allowing precise waste estimation for every manufacturing step
...
- **Real-time Scrap Calculations**: Updated cost summary to display total scrap across all processes alongside quantity and cost totals (e.g., "25 pcs (5 scrap)")
