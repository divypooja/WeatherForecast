...
class ManufacturingIntelligence:
    ...
    def analyze_process_bottlenecks(self, time_period_days=7):
        ...
        try:
            ...
            from models_intelligence import ProcessEfficiencyMetric
            ...
            return {
                ...
                'average_capacity_utilization': sum(p['capacity_utilization'] for p in process_analysis) / len(process_analysis),
    ...
    def generate_predictive_alerts(self):
        ...
        try:
            ...
            from models_intelligence import SupplierPerformanceMetric, ManufacturingAlert
            from app import db
    ...
    def _generate_system_recommendations(self, process_analysis):
        ...
        avg_efficiency = sum(p['average_efficiency'] for p in process_analysis if p['average_efficiency'] > 0)
        avg_efficiency = avg_efficiency / len([p for p in process_analysis if p['average_efficiency'] > 0])
