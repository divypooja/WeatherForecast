        ...
        with pd.ExcelWriter(output, engine='openpyxl') as writer:
            ...
            for prod in Production.query.all():
                prod_data.append({
                    ...
                    'Item': prod.item.name if prod.item else '',
                    'Planned Quantity': prod.planned_quantity,
                    'Produced Quantity': prod.produced_quantity,
                    'Good Quality Quantity': prod.good_quality_quantity,
                    'Damaged Quantity': prod.damaged_quantity,
